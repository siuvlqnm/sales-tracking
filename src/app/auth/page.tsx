...
export default function AuthPage() {
  ...
  return (
    <div className="h-screen min-h-screen flex items-start sm:items-center justify-center bg-gray-100 p-4 sm:p-6 overflow-hidden">
      <Card className="w-full max-w-md mx-auto mt-[15vh] sm:mt-0">
